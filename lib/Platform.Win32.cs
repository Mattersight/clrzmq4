	...
	public static partial class Platform
	{
		public static class Win32
		{
			...
			public static UnmanagedLibrary LoadUnmanagedLibrary(string libraryName)
			{
				...
				string resourceName = string.Format("ZeroMQ.{0}.{1}{2}", architecture, libraryName, ".dll");
				string fileName = string.Format("{0}{1}", libraryName, ".dll");
                string tempPath = Path.Combine(executingAssemblyDirectory, fileName);
